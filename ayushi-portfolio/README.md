...
├── work.html                 ← Full project index (all 6 case studies)
...
├── assets/
│   ├── style.css              ← All design/layout styling
│   ├── main.js                 ← Navigation, animations, PDF viewer logic
...
- **Multi-page structure** — Home, About, Work index, 6 individual project
